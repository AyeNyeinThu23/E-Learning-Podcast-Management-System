    ...
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        ...
        <ul class="submenu">
          ...
          <li><a href="enrolledAdmin.php">Joined Learners</a></li>
        </ul>
      </li>
      ...
      <li class="nav-item">
        ...
        <ul class="submenu">
          ...
          <li><a href="CourseInfoAdmin.php">Course Info</a></li>
        </ul>
      </li>
      <li class="nav-item">
...
$sql="SELECT 
    ...
    COALESCE(r.review, 'Not rated') AS Review
FROM Tutor t
JOIN TCA tc ON tc.TID = t.TID  
JOIN Courses c ON c.CID = tc.CID
JOIN Enrollment e ON e.CID = c.CID
JOIN Learner l ON l.LID = e.LID
LEFT JOIN Ratings r ON r.CID = c.CID AND r.LID = l.LID
ORDER BY t.name, c.CID, l.name";


$resultforEA = mysqli_query($con,$sql);
    ?>
    <div class="table-container">
      <h2>Joined Learners</h2>
        ...
        <table class="table">
          ...
          <tbody>
           <?php
                    ...
                    while ($course = mysqli_fetch_assoc($resultforEA)) {
              echo "<tr>";
              echo "<td>" . htmlspecialchars($course["LearnerName"]) . "</td>";
              echo "<td>" . htmlspecialchars($course["LearnerEmail"]) . "</td>";
              echo "<td>" . htmlspecialchars($course["TutorName"]) . "</td>";
              echo "<td>" . htmlspecialchars($course["CourseTitle"]) . "</td>";
              echo "<td>" . htmlspecialchars($course["Rating"]) . "</td>";
              echo "<td>" . htmlspecialchars($course["Review"]) . "</td>";
