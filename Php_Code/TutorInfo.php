        ...
        <table class="table">
          ...
          <?php
            ...
            while($user = mysqli_fetch_assoc($result)){
              ...
              <button class='btn btn-danger'><a href='deleteTutors.php?deTId=$id' onclick=\"return confirm('Are you sure you want to delete this tutor?')\"><i class='fas fa-trash-alt'> Delete</i></a></button>
