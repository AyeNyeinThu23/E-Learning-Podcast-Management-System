  ...
  while ($course = mysqli_fetch_assoc($result)) {
    ...
    echo "<tr class='main-row' data-target='details-$cid'>
            ...
            <td>
             ...
             <button class='btn btn-danger'><a href='deleteLessonAdmin.php?DLId=$lessonId' onclick=\"return confirm('Are you sure you want to delete this lesson?')\"><i class='fas fa-trash-alt'></i></a></button>
            </td>
...
?>
       ...
       <button type="button" class="btn btn-success">
         <a href="CourseInfoAdmin.php"> Back to Course Info</a>
        </button>
