...
<div class="super_container">
						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner">
								<ul class="main_nav">
									...
									<li class="active"><a href="instructors.php">Tutors</a></li>
	...
	<div class="teachers">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="section_title text-center">All Tutors in Every Field</h2>
				</div>
			</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="teacher d-flex flex-row align-items-center justify-content-start">
						...
						<div class="teacher_content">
							<div class="teacher_name"><a href="instructors.php"><?php echo $row["name"];?></a></div>
							<div class="teacher_title">Tutor</div>
						</div>
					</div>
				</div>
