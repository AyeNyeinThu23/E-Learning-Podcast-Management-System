...
session_start();
$sql = "CALL GetAdminDashboardTotals()";
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <div>
              <h5 class="card-title">Total Joined</h5>
              <p class="card-text">
                <?php
                  echo $totals['total_enrollments'];
                ?>
              </p>
            </div>
          </div>
