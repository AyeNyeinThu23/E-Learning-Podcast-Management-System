...
LEFT JOIN Lessons l ON l.CID = c.CID
GROUP BY c.CID, c.Title, c.language, t.TID, t.name
");
        ...
        <table class="table">
          ...
          <?php
            while($user = mysqli_fetch_assoc($result)){
              ...
              echo "<tr>";
              echo "<td>" . htmlspecialchars($user["tutor_name"]) . "</td>";
              echo "<td>" . htmlspecialchars($user["Title"]) . " (" . htmlspecialchars($user["language"]) . ")</td>";
              echo "<td><a href='lessonsAdmin.php?cid=".$user['CID']."'>".$user['total_lessons']."</a></td>";
              //echo "<td>" . nl2br($user['course_details']) . "</td>";
              echo "<td>
                     
                      <button class='btn btn-danger'><a href='deleteTutor.php?deCId=" . $user['CID'] . "' 
              onclick=\"return confirm('Are you sure you want to delete this course?')\"><i class='fas fa-trash-alt'> Delete</i></a></button>
                    </td>";
