				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body">
							<div class="course_title"><a href="course.php"><?php echo htmlspecialchars($row['Title']); ?></a></div>
							<div class="course_info">
								<ul>
									<li><a href="instructors.php"><?php echo htmlspecialchars($row['tutor_name']); ?></a></li>
									<li><a href="#"><?php echo htmlspecialchars($row['course_language']); ?></a></li>
								</ul>
							</div>
						...
						<div class="course_footer d-flex flex-row align-items-center justify-content-start">
							<div class="course_students"><i class="fa fa-user" aria-hidden="true"></i><span><?php echo htmlspecialchars($row['total_enrollments']); ?></span></div>
