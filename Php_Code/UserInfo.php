...
<head>
  ...
  <title>Admin Dashboard - Learner</title>
          ...
          <?php
            ...
            while($user = mysqli_fetch_assoc($result)){
              ...
              echo "<td>
                      ...
                      <button class='btn btn-danger'><a href='deleteLearner.php?deLId=$id' onclick=\"return confirm('Are you sure you want to delete this learner?')\"><i class='fas fa-trash-alt'> Delete</i></a></button>
                    </td>";
              echo "</tr>";
            }
          ?>
