      ...
      <div class="table-responsive">
        <table class="table">
         ...
         <?php
              ...
              echo "<td>" . htmlspecialchars($user["file_path"]) . "</td>";
              echo "<td>" . nl2br(htmlspecialchars($user['description'])) . "</td>";
              echo "<td>
                      <button class='btn btn-primary'><a href='updateLesson.php?ULId=$lessonId'><i class='fas fa-edit'></i></a></button>
                      <button class='btn btn-danger'><a href='deleteLesson.php?DLId=$lessonId'><i class='fas fa-trash-alt'></i></a></button>
                    </td>";
              echo "</tr>";
            }
          ?>
...
//else { echo "<p>No lessons found.</p>"; } // Optional: Show message when no lessons exist
?>
